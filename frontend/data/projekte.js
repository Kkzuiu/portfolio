...
export const projekte = [
 {
  tech: ['React', 'TypeScript', 'Vite', 'Tailwind CSS', 'Firebase', 'Gemini AI'],
    github: 'https://github.com/Kkzuiu/Dressify',
  demoVideo: '',
    image: '/projekte/Dressify.png',
    gallery: ['/projekte/Dressify.png'],
  title: 'Dressify',
  short: {
 ...
 {
  tech: ['TypeScript', 'Next.js', 'React', 'JavaScript', 'CSS', 'MongoDB'],
...

 {
  ...
  demoVideo: '',
    ...
    gallery: ['/projekte/cuzzle_game.png', '/projekte/Cuzzle.png', '/projekte/Cuzzle2.png'],
  title: 'Cuzzle',
  short: {
...

 {
  ...
  demoVideo: '',
    ...
    gallery: ['/projekte/hangman_light.png', '/projekte/hangman_dark.png'],
  title: 'CT Hangman',
  short: {
 ...
 {
  tech: ['LLVM', 'Java', 'C#', '.NET MAUI', 'XAML'],
 ...
 {
  tech: ['React', 'HTML', 'CSS', 'TS', 'PowerShell', 'Dockerfile', 'Go', 'JS', 'PocketBase', 'Firebase'],
...

 {
  ...
  demoVideo: '',
    ...
    gallery: ['/projekte/evently.png', '/projekte/evently_screen.png'],
  title: 'Evently',
  short: {
